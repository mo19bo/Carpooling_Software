...
import com.example.carsharing.LocationDemo.MyLocationListenner;

/**
 * 此demo用来展示如何进行驾车、步行、公交路线搜索并在地图使用RouteOverlay、TransitOverlay绘制
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class LocateAndRoutePlan extends Activity implements BaiduMap.OnMapClickListener,
...
//	BaiduMap mBaiduMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence titleLable = "constart";
        setTitle(titleLable);
		...
		OnClickListener btnClickListener = new OnClickListener() {
			public void onClick(View v) {
				mLocClient.start();//点了开始定位
				isFirstLoc = true;//设为真才能重复定位
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(LocateAndRoutePlan.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(LocateAndRoutePlan.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
